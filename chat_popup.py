...
def render_chat_popup():
    ...
    # Complete popup HTML with all content inside
    popup_html = f"""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div id="chatOverlay" onclick="closePopup()"></div>
        ...
        <div id="chatPopup">
            <div class="popup-header">
                ...
                <div class="header-controls">
                    <button class="control-btn" onclick="minimizePopup()" title="Minimize">−</button>
                    <button class="control-btn" onclick="maximizePopup()" title="{maximize_title}">{maximize_icon}</button>
                    <button class="control-btn close-btn" onclick="closePopup()" title="Close">×</button>
                </div>
            </div>
    ...
    # Render using components.html to keep everything contained
